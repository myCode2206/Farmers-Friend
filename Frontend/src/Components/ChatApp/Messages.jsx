    ...
    return (
        <div className="flex-grow h-full flex flex-col">
            ...
            {messages.map((message, index) => (
                ...
                <Usertext key={index}  msg={message} />
            ))}
                {/* another user ka text */}
                {/* <Usertext/> */}

                {/* user ka text end
                <Mytext Messages:myMessege /> */}
            </div>
            ...
            <div className="h-15  p-3 rounded-xl rounded-tr-none rounded-tl-none bg-gray-100 dark:bg-gray-800">
                <div className="flex items-center">
                    ...
                    <div className="search-chat flex flex-grow p-2">
                        ...
                        value={newMessage} 
                        className=" h-5 input text-gray-700 dark:text-gray-200 text-sm p-2 focus:outline-none bg-gray-100 dark:bg-gray-800  flex-grow rounded-l-md" type="text" 
